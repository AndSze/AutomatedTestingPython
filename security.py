...
def authenticate(username, password):
    ...
    with their user username and password.
    :param username: User's username in string format.
    :param password: User's un-encrypted password in string format.
    :return: A UserModel object if authentication was successful, None (Python returns it by default) otherwise.
    """
